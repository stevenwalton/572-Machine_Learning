...
for i in range(len(historical_data)):
    print(np.linalg.norm(historical_data[i][:-1] - p1))
14.331172317713579
>> 6.715362983487936
10.955934464937256
11.102364613000242
...
for i in range(len(hist_data)):
    print(np.linalg.norm(hist_data[i][:-1]-p2))
...
for i in range(len(hist_data)):
    print(np.linalg.norm(hist_data[i][:-1]-p3))
...
4.249341125398148
\end{lstlisting}
We can easily see that the closest label (marked with $>>$) is that of ID=2, which is labeled BAD,
therefore we should label P1 as BAD.

Doing this again we see that P2 is closest to ID=1, so GOOD.

P3 is closest to ID=4, so BAD
