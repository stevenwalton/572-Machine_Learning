...
\begin{frame}
    ...
    \begin{centering}
    \includegraphics<2>[width=0.5\textwidth]{out.png}
...
\begin{frame}
    ...
    \begin{itemize}
        \item<1-> Unets aren't the way to solve this problem. (Not even close!)
        \item<2-> Research is HARD!
        \item<3-> Just because it is ML doesn't mean it can learn everything.
        \item<4-> Searching around shows that autoencoders might be promising.
        \item<5-> Every failure is another step in the process of solving hard problems.
    \end{itemize}
\end{frame}
